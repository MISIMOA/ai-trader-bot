...
def main_loop():
    ...
    while True:
        ...
        try:
            ...
            #!/usr/bin/env python3
"""
🤖 TRADING BOT IA v2 FINAL - CLAUDE API + 7 INDICATEURS
RSI | Bollinger Bands | MACD | FVG | Volume | Order Blocks | DXY
Mode: DÉMO (affichage des décisions, pas de vrai trading)
FIX: ANTHROPIC_ORG_ID correctement envoyé au client Claude
"""
...
print("=" * 80)
print("🤖 TRADING BOT IA v2 FINAL - DÉMARRAGE")
print("=" * 80)
print(f"⏰ {datetime.now()}")
print()
...
print(f"✅ Org ID found: {ANTHROPIC_ORG_ID}")
print()

# Initialiser Anthropic avec ORG_ID
try:
    client = Anthropic(
        api_key=ANTHROPIC_API_KEY,
        organization_id=ANTHROPIC_ORG_ID  # FIX: Envoyer l'org ID correctement
    )
    print("✅ Anthropic client initialized with organization_id")
except Exception as e:
...
if __name__ == "__main__":
    print("✅ Bot v2 FINAL avec 7 indicateurs PRÊT!")
